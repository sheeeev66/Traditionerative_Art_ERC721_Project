...
using Traditionerative_Art_ERC721_Project.Contracts.TraditionerativeArtFactory.ContractDefinition;

namespace Traditionerative_Art_ERC721_Project.Contracts.TraditionerativeArtFactory
{
    public partial class TraditionerativeArtFactoryService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, TraditionerativeArtFactoryDeployment traditionerativeArtFactoryDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<TraditionerativeArtFactoryDeployment>().SendRequestAndWaitForReceiptAsync(traditionerativeArtFactoryDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, TraditionerativeArtFactoryDeployment traditionerativeArtFactoryDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<TraditionerativeArtFactoryDeployment>().SendRequestAsync(traditionerativeArtFactoryDeployment);
        }

        public static async Task<TraditionerativeArtFactoryService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, TraditionerativeArtFactoryDeployment traditionerativeArtFactoryDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, traditionerativeArtFactoryDeployment, cancellationTokenSource);
            return new TraditionerativeArtFactoryService(web3, receipt.ContractAddress);
        }
        ...
        public TraditionerativeArtFactoryService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
        ...
        public Task<BigInteger> BpQueryAsync(BpFunction bpFunction, BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<BpFunction, BigInteger>(bpFunction, blockParameter);
        }

        
        public Task<BigInteger> BpQueryAsync(BlockParameter blockParameter = null)
        {
            return ContractHandler.QueryAsync<BpFunction, BigInteger>(null, blockParameter);
        }
        ...
        public Task<string> SafeMintTgaRequestAsync(SafeMintTgaFunction safeMintTgaFunction)
        {
             return ContractHandler.SendRequestAsync(safeMintTgaFunction);
        }

        public Task<TransactionReceipt> SafeMintTgaRequestAndWaitForReceiptAsync(SafeMintTgaFunction safeMintTgaFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(safeMintTgaFunction, cancellationToken);
        }

        public Task<string> SafeMintTgaRequestAsync(string to)
        {
            var safeMintTgaFunction = new SafeMintTgaFunction();
                safeMintTgaFunction.To = to;
            
             return ContractHandler.SendRequestAsync(safeMintTgaFunction);
        }

        public Task<TransactionReceipt> SafeMintTgaRequestAndWaitForReceiptAsync(string to, CancellationTokenSource cancellationToken = null)
        {
            var safeMintTgaFunction = new SafeMintTgaFunction();
                safeMintTgaFunction.To = to;
        ...
        public Task<string> WithdrawRequestAsync(string address)
        {
            var withdrawFunction = new WithdrawFunction();
                withdrawFunction.Address = address;
            
             return ContractHandler.SendRequestAsync(withdrawFunction);
        }

        public Task<TransactionReceipt> WithdrawRequestAndWaitForReceiptAsync(string address, CancellationTokenSource cancellationToken = null)
        {
            var withdrawFunction = new WithdrawFunction();
                withdrawFunction.Address = address;
